<template>
  <div>
    <div class="header">
      <div style="color:#5e84f3;font-size: 1.2em;font-weight: bold;padding-top: 15px"><h1 style="margin: 0 0 0 20px">用户管理</h1></div>
    ...
    <div class="footer">
      <div style="margin-left: 20px;padding-top: 15px">
        <div style="margin-bottom: 15px">
          <el-button style="background: #5086ff;color: #fff;border-radius: 10px"><i class="el-icon-plus"></i> 添加用户</el-button>
        </div>
        <div>
          <el-table
            :data="appList"
